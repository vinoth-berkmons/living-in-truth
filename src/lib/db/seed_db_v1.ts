...
const workspaces: Workspace[] = [
  { id: WS_GLOBAL, name: 'Global', slug: 'global', status: 'active', enabledLanguages: ['en', 'ta', 'hi', 'ml', 'kn', 'te'], defaultLanguage: 'en', themeOverride: { accentColor: '175 46% 44%' }, createdAt: now, updatedAt: now },
  { id: WS_KIDS, name: 'Kids', slug: 'kids', status: 'active', enabledLanguages: ['en'], defaultLanguage: 'en', themeOverride: { accentColor: '37 90% 55%' }, createdAt: now, updatedAt: now },
  ...
  { id: WS_COUPLES, name: 'Couples', slug: 'couples', status: 'active', enabledLanguages: ['en'], defaultLanguage: 'en', themeOverride: { accentColor: '0 72% 55%' }, createdAt: now, updatedAt: now },
  ...
  { id: WS_SERVANTS, name: 'Servants', slug: 'servants', status: 'active', enabledLanguages: ['en'], defaultLanguage: 'en', themeOverride: { accentColor: '210 60% 50%' }, createdAt: now, updatedAt: now },
];
...
const contentItems: ContentItem[] = [
  ...
  // ---- New MFC articles ----
  {
    id: 'content-global-008', type: 'article', slug: 'the-eucharist-and-community', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-worship'], access: 'free',
    coverImageUrl: 'https://images.unsplash.com/photo-1544027993-37dbfe43562a?w=800&q=80',
    authorName: 'Missionary Families of Christ',
    translations: { en: { title: 'The Eucharist and Community Life', excerpt: 'The Eucharist is the source and summit of our Christian life, drawing us together as one body in Christ.', bodyHtml: '<p>The Eucharist is not simply a ritual we perform on Sundays. It is the living heart of our faith, the moment when heaven touches earth and we are united with Christ and with one another.</p><h2>Source and Summit</h2><p>The Second Vatican Council declared that the Eucharist is the source and summit of the Christian life. Everything flows from the Eucharist, and everything leads back to it.</p><h2>Building Community</h2><p>When we gather around the table of the Lord, we are formed into a community. The Eucharist breaks down barriers and creates bonds of love that transcend all human differences.</p><h2>Sent Forth</h2><p>The word "Mass" comes from the Latin "missa" — to be sent. After receiving the Eucharist, we are sent forth to be Christ\'s presence in the world.</p>' } },
  },
  {
    id: 'content-global-009', type: 'article', slug: 'role-of-mary-in-catholic-life', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-faith'], access: 'free',
    coverImageUrl: 'https://images.unsplash.com/photo-1548407260-da850faa41e8?w=800&q=80',
    authorName: 'Missionary Families of Christ',
    translations: { en: { title: 'The Role of Mary in Catholic Life', excerpt: 'Mary, the Mother of God, holds a unique place in Catholic devotion as our spiritual mother and model of faith.', bodyHtml: '<p>From the earliest days of Christianity, Mary has been honored as the Mother of God — Theotokos. Her role in salvation history is unique and irreplaceable.</p><h2>Mother of the Church</h2><p>At the foot of the cross, Jesus entrusted Mary to the beloved disciple and the beloved disciple to Mary. In that moment, Mary became the mother of all believers.</p><h2>Model of Faith</h2><p>Mary\'s "fiat" — her "yes" to God — is the model for every Christian\'s response to God\'s call. She teaches us to trust completely in God\'s plan, even when we do not fully understand it.</p><h2>The Rosary</h2><p>The Rosary is one of the most powerful prayers in Catholic tradition, a meditation on the mysteries of Christ\'s life through the eyes of His mother.</p>' } },
  },
  {
    id: 'content-global-010', type: 'blog', slug: 'living-the-beatitudes', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_EDITOR, updatedByUserId: USER_EDITOR,
    categoryIds: ['cat-global-sermons'], access: 'free',
    coverImageUrl: 'https://images.unsplash.com/photo-1447005497901-b3e9ee359928?w=800&q=80',
    authorName: 'Missionary Families of Christ',
    translations: { en: { title: 'Living the Beatitudes Today', excerpt: 'The Beatitudes are not just ideals — they are a practical roadmap for living as disciples of Christ in the modern world.', bodyHtml: '<p>When Jesus preached the Sermon on the Mount, He turned the world\'s values upside down. Blessed are the poor in spirit. Blessed are those who mourn. Blessed are the meek.</p><h2>Counter-Cultural Living</h2><p>The Beatitudes challenge us to live counter-culturally. In a world that prizes wealth, power, and pleasure, Jesus calls us to poverty of spirit, gentleness, and hunger for righteousness.</p><h2>Peacemakers</h2><p>"Blessed are the peacemakers, for they shall be called children of God." In our families, our communities, and our world, we are called to be instruments of peace.</p>' } },
  },
  {
    id: 'content-global-011', type: 'article', slug: 'catholic-social-teaching', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-life'], access: 'premium',
    coverImageUrl: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80',
    authorName: 'Missionary Families of Christ',
    translations: { en: { title: 'Catholic Social Teaching: Faith in Action', excerpt: 'Catholic Social Teaching calls us to build a just society rooted in the dignity of every human person.', bodyHtml: '<p>Catholic Social Teaching is the Church\'s best-kept secret — a rich tradition of thought on justice, peace, and human dignity that spans over a century of papal encyclicals.</p><h2>Human Dignity</h2><p>Every human person, from conception to natural death, possesses an inherent dignity that must be respected and protected. This is the foundation of all Catholic Social Teaching.</p><h2>Common Good</h2><p>We are called to work for the common good — conditions that allow all people to reach their full potential. This means caring not just for ourselves but for the most vulnerable.</p><h2>Preferential Option for the Poor</h2><p>Jesus identified Himself with the poor and marginalized. As His followers, we must make their needs our priority.</p>' } },
  },
  {
    id: 'content-global-012', type: 'blog', slug: 'youth-faith-formation', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_EDITOR, updatedByUserId: USER_EDITOR,
    categoryIds: ['cat-global-faith'], access: 'free',
    coverImageUrl: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=800&q=80',
    authorName: 'Missionary Families of Christ',
    translations: { en: { title: 'Youth and Faith Formation', excerpt: 'Forming young people in faith is one of the most important missions of the Church and the family.', bodyHtml: '<p>The future of the Church depends on how well we form our young people in faith today. This is not just the responsibility of priests and catechists — it is the primary responsibility of parents.</p><h2>The Family as School of Faith</h2><p>The family is the first school of faith. Children learn to pray, to love, and to serve by watching their parents. What we model in our homes is more powerful than any textbook.</p><h2>Engaging Youth</h2><p>Young people today face unprecedented challenges — social media, peer pressure, secularism. We must find creative ways to make the faith relevant and alive for them.</p><h2>World Youth Day</h2><p>Events like World Youth Day remind us that the faith is young, vibrant, and full of hope. Our young people are not just the future of the Church — they are the Church today.</p>' } },
  },
];
...
const videoItems: VideoItem[] = [
  ...
  // ---- New long-format videos ----
  {
    id: 'video-global-009', slug: 'what-to-give-up-for-lent', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-faith'], access: 'free', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=Jc3FGjYf_hM', youtubeId: 'Jc3FGjYf_hM' },
    translations: { en: { title: 'What to Give Up for Lent? Best Things to Give Up for Lenten Season', description: 'Practical and meaningful ideas for Lenten sacrifices that will deepen your faith and draw you closer to God.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/Jc3FGjYf_hM/hqdefault.jpg',
    durationSeconds: 355,
  },
  {
    id: 'video-global-010', slug: 'same-sex-attraction-indian-catholic', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-life'], access: 'premium', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=vs56Z-VhpYk', youtubeId: 'vs56Z-VhpYk' },
    translations: { en: { title: 'Experiencing Same Sex Attraction as an Indian Catholic - Krysanne Martis', description: 'An honest and compassionate UC Talks episode with Krysanne Martis sharing her journey as an Indian Catholic experiencing same-sex attraction.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/vs56Z-VhpYk/hqdefault.jpg',
    durationSeconds: 4297,
  },
  {
    id: 'video-global-011', slug: 'catholic-reacts-beautiful-things', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_EDITOR, updatedByUserId: USER_EDITOR,
    categoryIds: ['cat-global-worship'], access: 'free', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=3IyJs7mWEWk', youtubeId: '3IyJs7mWEWk' },
    translations: { en: { title: 'Catholic REACTS to Beautiful Things by Benson Boone', description: 'A Catholic perspective on Benson Boone\'s hit song Beautiful Things — exploring the faith themes in popular music.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/3IyJs7mWEWk/hqdefault.jpg',
    durationSeconds: 321,
  },
  {
    id: 'video-global-012', slug: 'psalms-reveal-jesus-messiah', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-sermons'], access: 'free', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=hnKCHMDfdoA', youtubeId: 'hnKCHMDfdoA' },
    translations: { en: { title: 'The Psalms Reveal Jesus as the Messiah', description: 'Discovering how the Old Testament Psalms point to Jesus Christ as the promised Messiah.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/hnKCHMDfdoA/hqdefault.jpg',
    durationSeconds: 211,
  },
  {
    id: 'video-global-013', slug: 'why-catholics-confess-to-priest', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-faith'], access: 'free', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=GzO6iN1eFIM', youtubeId: 'GzO6iN1eFIM' },
    translations: { en: { title: 'Why Do Catholics Confess to a Priest?', description: 'Understanding the biblical and historical basis for the Sacrament of Confession in the Catholic Church.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/GzO6iN1eFIM/hqdefault.jpg',
    durationSeconds: 612,
  },
  {
    id: 'video-global-014', slug: 'is-the-rosary-biblical', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-worship'], access: 'free', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=X82AaeyPPe4', youtubeId: 'X82AaeyPPe4' },
    translations: { en: { title: 'Is the Rosary Biblical? Catholic Answers', description: 'Examining the biblical foundations of the Rosary and answering common Protestant objections.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/X82AaeyPPe4/hqdefault.jpg',
    durationSeconds: 584,
  },
  {
    id: 'video-global-015', slug: 'saints-and-miracles-explained', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-faith'], access: 'premium', format: 'long',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=Jy1waLtNKzw', youtubeId: 'Jy1waLtNKzw' },
    translations: { en: { title: 'Catholic Saints and Miracles Explained', description: 'How the Catholic Church verifies miracles and canonizes saints — the process behind sainthood.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/Jy1waLtNKzw/hqdefault.jpg',
    durationSeconds: 645,
  },
  // --- Short-format videos ---
  {
  ...
  // ---- New shorts ----
  {
    id: 'video-global-s06', slug: 'tumblr-safe-space-short', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-life'], access: 'free', format: 'short',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=kHnz-PSB61M', youtubeId: 'kHnz-PSB61M' },
    translations: { en: { title: 'Tumblr Used to Be My Safe Space', description: 'A personal reflection on internet culture and finding faith beyond online spaces.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/kHnz-PSB61M/hqdefault.jpg',
    durationSeconds: 59,
  },
  {
    id: 'video-global-s07', slug: 'natural-family-planning-short', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_EDITOR, updatedByUserId: USER_EDITOR,
    categoryIds: ['cat-global-life'], access: 'free', format: 'short',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=kVrhaE9xgUM', youtubeId: 'kVrhaE9xgUM' },
    translations: { en: { title: 'What is Natural Family Planning?', description: 'A brief introduction to Natural Family Planning from a Catholic perspective.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/kVrhaE9xgUM/hqdefault.jpg',
    durationSeconds: 32,
  },
  {
    id: 'video-global-s08', slug: 'why-be-catholic-short', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-faith'], access: 'free', format: 'short',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=5wQqv2PdZpc', youtubeId: '5wQqv2PdZpc' },
    translations: { en: { title: 'Why Be Catholic? One Minute Answer', description: 'A powerful one-minute answer to the question: Why should I be Catholic?' } },
    coverImageUrl: 'https://i.ytimg.com/vi/5wQqv2PdZpc/hqdefault.jpg',
    durationSeconds: 60,
  },
  {
    id: 'video-global-s09', slug: 'catholic-vs-protestant-short', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_ADMIN, updatedByUserId: USER_ADMIN,
    categoryIds: ['cat-global-sermons'], access: 'free', format: 'short',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=ArUuakk3Wtg', youtubeId: 'ArUuakk3Wtg' },
    translations: { en: { title: 'Catholic vs Protestant: Key Differences', description: 'A quick overview of the key differences between Catholic and Protestant Christianity.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/ArUuakk3Wtg/hqdefault.jpg',
    durationSeconds: 90,
  },
  {
    id: 'video-global-s10', slug: 'prayer-tips-short', workspaceId: WS_GLOBAL,
    status: 'published', publishedAt: now, createdAt: now, updatedAt: now,
    createdByUserId: USER_EDITOR, updatedByUserId: USER_EDITOR,
    categoryIds: ['cat-global-worship'], access: 'free', format: 'short',
    source: { provider: 'youtube', url: 'https://www.youtube.com/watch?v=yk1jZxbk3N4', youtubeId: 'yk1jZxbk3N4' },
    translations: { en: { title: '3 Tips to Improve Your Prayer Life', description: 'Simple but powerful tips to deepen your daily prayer practice.' } },
    coverImageUrl: 'https://i.ytimg.com/vi/yk1jZxbk3N4/hqdefault.jpg',
    durationSeconds: 45,
  },
];
...
const homeSections: HomeSection[] = [
  ...
  { id: 'hs-global-hero', workspaceId: WS_GLOBAL, type: 'hero_slider', sortOrder: 0,
    itemRefs: [
      ...
      { entityType: 'video', id: 'video-global-009' },
      { entityType: 'content', id: 'content-global-009' },
    ],
    createdAt: now, updatedAt: now },
